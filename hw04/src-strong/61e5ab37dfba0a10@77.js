...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>減少包裝材及文宣印製在全台各地都是首要執行的方案</li>
    <li>北部相較南部傾向於使用無毒媒材、再生材料、廢物利用素材</li>
  </ul>
</h3>`
)}
...
d3
  .scaleOrdinal()
  .domain(["工作室", "替代空間", "美術館", "減少包裝材及文宣印製", "使用無毒媒材、再生材料、廢物利用素材等", "工作場所、活動展場的節約能源","減少商務差旅","選擇符合永續精神的活動場地","沒有","用海運或陸運取代空運","北部", "中部", "南部", "東部", "國外"])
  //.range(d3.schemePaired)
  .range(["#241168","#22667F","#378179","#F33BD3","#61449F","#110092","#940ff2","#330332","#120f11"])
  .unknown("#BEBEBE")
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artist-1-1.csv", {url: new URL("./files/50c5f49fe0be94803e1d055aaca895517461971b40fc91cc553044dee88321c73843858f823684904e961847c7cc5d3bb60f8ecd7cdfde293dd65a61d08e1e2d.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
